          ...
          <Toolbar sx={{ px: { xs: 1.5, md: 0, lg: 0 }, py: 2 }}>
            ...
            >
              <Link
                ...
                to={isAuthenticated ? APP_DEFAULT_PATH : '/login'}
                target="_blank"
                underline="none"
              >
            ...
            <Box sx={{ width: '100%', alignItems: 'center', justifyContent: 'space-between', display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                ...
                >
                  <List>
                    <Link underline="none" href={isAuthenticated ? APP_DEFAULT_PATH : '/login'} target="_blank">
                      <ListItemButton>
                        <ListItemIcon>
                          <LineOutlined />
                        </ListItemIcon>
                        <ListItemText
                          primary={isAuthenticated ? 'Dashboard' : 'Login'}
